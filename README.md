...
🚿 Data Cleaning? Check it out here: [cleaning file]([https://github.com/AJ-Carp/Data-Science-Job-Analysis-Project/tree/main/Project_queries](https://github.com/AJ-Carp/Company-Funds-and-Layoffs-Project/blob/main/cleaning.sql))
